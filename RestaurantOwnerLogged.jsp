...
<%
   int usertype = (Integer) session.getAttribute("usertype");
    if(((session.getAttribute("currentSessionUser")== null ) || (session.getAttribute("currentSessionUser")== ""))
    		&& (session.getAttribute("usertype")==null) || (usertype!=3)){
...
<ul>
  ...
  <li><a href="EditRestaurantProfileServlet">Edit Restaurant Profile</a></li>
  <li><a href="EditMenu.jsp">Edit Menu</a></li>
  <li><a href="DisplayIncomingOrders.jsp">Incoming Orders</a></li>
